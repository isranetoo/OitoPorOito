        ...
        <span className="flex items-center gap-1 font-semibold text-white truncate">
          ...
          {flagUrl ? (
            <img
              src={flagUrl}
              alt={flagAlt}
              className="w-6 h-4 object-cover rounded-sm border border-[#444] bg-[#232526] align-middle"
              title={flagAlt}
              draggable={false}
            />
          ) : (
            <span className="w-6 h-4 ml-1 bg-gray-500 rounded-sm border border-[#444] align-middle text-[10px] flex items-center justify-center text-white px-1">--</span>
          )}
        </span>
      </div>
