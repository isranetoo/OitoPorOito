...
export default function PlayerInfoPlay({ avatar, name, rating, flagUrl, flagAlt = "", isBot }) {
  // Se for bot, sempre mostra "Gust" como nome
  const displayName = isBot ? "Gust" : name;
  return (
    <div
