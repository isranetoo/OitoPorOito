...
export default function ChessHome() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-[#232526] via-[#1a1a1a] to-[#232526] text-white font-sans px-2 py-8 md:py-16 gap-8"
    >
      {/* COLUNA CENTRAL: PlayerInfoPlay acima, tabuleiro, PlayerInfoPlay abaixo */}
      ...
      <motion.section
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.7, ease: 'easeOut' }}
        className="w-full max-w-xs md:max-w-sm bg-gradient-to-r from-[#232526] via-[#1a1a1a] to-[#232526] p-7 md:p-8 rounded-2xl shadow-2xl border-t-2 border-b-2 border-[#c29d5d]/30 flex flex-col gap-4"
      >
